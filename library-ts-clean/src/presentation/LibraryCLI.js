...
class LibraryCLI {
    ...
    showReturn(loanId) {
        ...
        if (result.ok) {
            console.log(`   ${result.message}`);
            if ((_a = result.data) === null || _a === void 0 ? void 0 : _a.fine) {
    ...
    showDailyReport() {
        ...
        if (report.transactions.length > 0) {
            ...
            report.transactions.forEach((tx) => {
                ...
                console.log(`  ${time}  ${type.padEnd(12)} "${tx.bookTitle}" ${(_a = tx.memberName) !== null && _a !== void 0 ? _a : ""}${fine}`);
            });
        }
    }
}
exports.LibraryCLI = LibraryCLI;
//# sourceMappingURL=LibraryCLI.js.map
