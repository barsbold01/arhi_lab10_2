...
class LibraryService {
    ...
    returnBook(loanId) {
        ...
        this.transactions.push({
            ...
            fineAmount: (_a = fine === null || fine === void 0 ? void 0 : fine.amount) !== null && _a !== void 0 ? _a : 0,
            timestamp: new Date(),
        });
        const msg = fine
    ...
    getDailyReport() {
        ...
        return {
            ...
            finesCollected: todayTx.reduce((sum, t) => { var _a; return sum + ((_a = t.fineAmount) !== null && _a !== void 0 ? _a : 0); }, 0),
